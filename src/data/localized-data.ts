        ...
        projects: [
          {
            ...
            details: ['要件定義、設計、実装、テスト', 'チーム内での技術指導とレビュー'],
          ...
          },
          {
            ...
            details: ['レガシーコードのリファクタリング', 'パフォーマンス改善（ロード時間50%削減）'],
    ...
    en: [
      {
        ...
        projects: [
          ...
          },
          {
            ...
            details: ['Legacy code refactoring', 'Performance improvement (50% reduction in loading time)'],
            technologies: ['Vue.js', 'Node.js', 'SQL'],
          },
        ],
      },
