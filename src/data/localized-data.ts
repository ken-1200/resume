  ...
  const workHistories = {
    ja: [
      ...
      },
      {
        ...
        projects: [
          {
            title: 'インフラ基盤移行プロジェクト（PoD/FO対応）',
            period: '2024/11 ～ 2025/06',
            summary: 'PMとして3名のチームを管理し、VPC・DB移行を含む大規模インフラ改善を実施',
            details: [
              'プロジェクト管理・インフラ構成改善・ネットワーク移行を主導',
              '週次MTGを通じた進捗管理と課題解決',
          ...
          },
          {
            ...
            details: [
              'AWS Batchを活用した効率的なバッチ処理システムの構築',
              'インドネシア料金計算、ScanToCall、かけ放題プランなど新契約形態への対応',
              '複数キャリア混在料金計算により経理チームの作業時間を14時間削減',
              '発信パック併用機能によりMRR約100万円増加に貢献',
              'コードリーディング会実施による属人化解消',
            ],
          ...
          },
          {
            ...
            technologies: ['Python', 'JavaScript', 'FastAPI', 'React', 'PostgreSQL'],
          },
        ],
      },
      {
        ...
        projects: [
          ...
          },
          {
            ...
            details: [
              ...
              'Implemented new contract types including Indonesia billing, ScanToCall, and unlimited call plans',
              'Reduced accounting team work by 14 hours through multi-carrier billing calculation',
              'Contributed to ~¥1M MRR increase through outbound pack feature',
              'Reduced knowledge silos through code reading sessions',
            ],
