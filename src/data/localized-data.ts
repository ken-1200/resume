...
export function useProfileData() {
  ...
  const selfPrText = {
    ja: [
      ...
      '特に、レガシーシステムの刷新や業務効率化において、技術的な解決策をビジネス価値に結びつけることを得意としています',
    ...
    en: [
      ...
      'I excel at connecting technical solutions to business value, particularly in legacy system modernization and operational efficiency improvements',
