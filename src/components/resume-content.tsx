            ...
            >
              <Card className="shadow-sm bg-white dark:bg-neutral-800 border-slate-200 dark:border-neutral-700/50">
                ...
                <CardContent className="pt-4 space-y-8">
                  {/* 本業セクション */}
                  <div>
                    <h3 className="text-lg font-semibold mb-4 text-slate-800 dark:text-neutral-100">{t('workHistory.mainJob')}</h3>
                    <div className="space-y-8">
                      {mainJobs.map((company, companyIdx) => (
                        <div key={`main-${companyIdx}`} className="space-y-5">
                          {/* 会社情報 */}
                          <div className="border-l-2 pl-4 py-1 border-blue-600/30 dark:border-blue-800/70">
                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                              <h4 className="font-semibold text-lg text-slate-800 dark:text-neutral-100">
                                {company.companyName}
                              </h4>
                            ...
                            <div>
                              ...
                              <div className="space-y-3 relative">
                                ...
                                {company.projects.map((project, projIdx) => {
                                  const projectKey = `main-${companyIdx}-${projIdx}`;
                                    ...
                                    >
                                      <CollapsibleTrigger asChild>
                                        <div
                                          ...
                                          aria-controls={`project-content-main-${companyIdx}-${projIdx}`}
                                        >
                                      ...
                                      <CollapsibleContent
                                        id={`project-content-main-${companyIdx}-${projIdx}`}
                  ...
                  {/* 副業セクション */}
                  <div>
                    <h3 className="text-lg font-semibold mb-4 text-slate-800 dark:text-neutral-100">{t('workHistory.sideProject')}</h3>
                    <div className="space-y-8">
                      {sideProjects.map((company, companyIdx) => (
                        <div key={`side-${companyIdx}`} className="space-y-5">
                          {/* 会社情報 */}
                          <div className="border-l-2 pl-4 py-1 border-green-600/30 dark:border-green-800/70">
                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                              <h4 className="font-semibold text-lg text-slate-800 dark:text-neutral-100">
                                {company.companyName}
                              </h4>
                            ...
                            <p className="text-sm mt-1 text-green-600 dark:text-green-300">{company.position}</p>
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-[30%_1fr] gap-5 pl-2">
                            ...
                            <div>
                              ...
                              <div className="space-y-3 relative">
                                ...
                                {company.projects.map((project, projIdx) => {
                                  const projectKey = `side-${companyIdx}-${projIdx}`;
                                  const isOpen = openProjects[projectKey] || false;
                                    ...
                                    >
                                      <CollapsibleTrigger asChild>
                                        <div
                                          ...
                                          role="button"
                                          aria-expanded={isOpen}
                                          aria-controls={`project-content-side-${companyIdx}-${projIdx}`}
                                        >
                                          <div className="flex items-center flex-1 min-w-0">
                                            <div
                                              className={`
                                      ...
                                      <CollapsibleContent
                                        id={`project-content-side-${companyIdx}-${projIdx}`}
                                        className="animate-in fade-in-0 data-[state=closed]:animate-out data-[state=closed]:fade-out-0"
                                      >
                                        <div className="p-4 pt-2 border-t border-slate-200 dark:border-neutral-700/50 bg-slate-50/50 dark:bg-neutral-800/50">
                                          <div className="mb-3">
                          ...
                          {companyIdx < sideProjects.length - 1 && (
                            <Separator className="bg-slate-200 dark:bg-neutral-700/50" />
                          )}
                        </div>
                      ))}
